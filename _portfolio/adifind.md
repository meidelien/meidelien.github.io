...
<div class="adifind-page__intro">
  ...
  AdiFind is research software for tumour-adjacent adipose analysis on whole-slide histology images. Pre-release example results and downloads are available below and can be inspected in the QuPath viewer. More information about AdiFind will be released soon™. For questions or collaboration, please contact me at martin [dot] lien [at] uib [dot] no.
</div>
